...
const PlatformIntro    = lazy(() => import('../components/sections/PlatformIntro'));
const PopularCities    = lazy(() => import('../components/sections/PopularCities'));
...
const SectionFallback = () => (
  <div style={{ minHeight: '200px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
    <span className="text-muted" style={{ fontSize: '0.85rem' }}>Loading…</span>
  </div>
);
...
const Home = () => {
  return (
    <div className="home-page">
        ...
        <div className="container hero-content">
          ...
          >
            ...
            <p className="text-muted mt-2 mb-4">
              Search, compare, and book verified student accommodations near top universities worldwide.
            </p>
            ...
            <div className="search-bar glass" role="search">
              ...
              <Link to="/accommodations" className="btn btn-primary" id="hero-find-accommodation">
            ...
            <div className="hero-sublinks">
              <Link to="/accommodations" className="hero-sublink">London</Link>
              <Link to="/accommodations" className="hero-sublink">Manchester</Link>
              <Link to="/accommodations" className="hero-sublink">Edinburgh</Link>
              <Link to="/accommodations" className="hero-sublink">Birmingham</Link>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      {/* ── 2. TRUST STATS ──────────────────────────── */}
      <section className="section-padding trust-section bg-surface" aria-label="Platform statistics">
      ...
      {/* ── 11. FINAL CTA ───────────────────────────── */}
      <section className="cta-section section-padding" aria-label="Final call to action">
        <div className="container text-center">
          ...
          >
            ...
            <p className="mb-3">
              Get expert housing consultation and priority accommodation access — completely free.
            </p>
            <div className="cta-final-actions">
              <Link to="/accommodations" className="btn btn-accent" id="final-cta-explore">
                Explore Properties
              </Link>
              <Link to="/contact" className="btn cta-btn-ghost" id="final-cta-expert">
